...
namespace FrameWork.GameSettings
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_PathLabelProperty = serializedObject.FindProperty("m_PathLabel");
            m_RebindOverlayProperty = serializedObject.FindProperty("m_RebindOverlay");
            m_RebindActionLabelProperty = serializedObject.FindProperty("m_RebindActionLabel");
            m_RebindPathLabelProperty = serializedObject.FindProperty("m_RebindPathLabel");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_PathLabelProperty);
                EditorGUILayout.PropertyField(m_RebindOverlayProperty);
                EditorGUILayout.PropertyField(m_RebindActionLabelProperty);
                EditorGUILayout.PropertyField(m_RebindPathLabelProperty);
            }
        ...
        private SerializedProperty m_PathLabelProperty;
        private SerializedProperty m_RebindOverlayProperty;
        private SerializedProperty m_RebindActionLabelProperty;
        private SerializedProperty m_RebindPathLabelProperty;
